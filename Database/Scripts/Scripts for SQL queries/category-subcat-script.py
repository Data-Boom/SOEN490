...
# The JSON used is the newdatasets.json which was produced by the datasets-builder.py script found in Builders folder.

import json

file = open('category-subcat-query.txt', "w+")
...
with open('newdatasets.json', 'w') as outfile:
