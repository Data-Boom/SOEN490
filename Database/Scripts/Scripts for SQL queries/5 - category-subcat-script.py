...
file.write(" INSERT INTO `databoom_db`.`subcategory` (`name`, `id`) VALUES ('N/A', 1);\n")
...
for x in data: # Loop through dataset
    ...
    if data[x]['category'] not in list_of_category:
        ...
        # Category query
        file.write(" INSERT INTO `databoom_db`.`category` (`id`,`name`) VALUES ("+str(categoryIdCount)+",\""+data[x]['category']+"\");\n")
    ...
    if data[x]['subcategory'] not in list_of_subcategory:
        ...
        # Subcategory query
        file.write(" INSERT INTO `databoom_db`.`subcategory` (`id`,`name`) VALUES ("+str(subcategoryIdCount)+",\""+data[x]['subcategory']+"\");\n")
