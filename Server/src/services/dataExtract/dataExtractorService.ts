...
import { IDataExtractorService } from './IDataExtractorService'
 ...
 */
export class dataExtractorService extends IDataExtractorService {
  ...
  private async jsonUpload(filePath: string): Promise<string> {
    ...
    let jsonObj = this.parseFile(filePath)
